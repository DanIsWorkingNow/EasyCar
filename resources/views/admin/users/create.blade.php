    ...
    <div style="background: rgba(255,255,255,0.95); backdrop-filter: blur(15px); border-radius: 25px; padding: 2.5rem; box-shadow: 0 20px 40px rgba(0,0,0,0.1); position: relative; overflow: hidden;">
        ...
        <div style="display: flex; align-items: center; gap: 0.85rem; margin-bottom: 2rem;">
            ...
            <div>
                ...
                <p style="color: #6b7280; margin: 0.15rem 0 0 0; font-size: 0.9rem;">Create a staff or admin account</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 1.25rem;">
                <div>
                    <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #374151; margin-bottom: 0.4rem;">Password</label>
                    <input type="password" name="password" required
                           style="width: 100%; padding: 0.75rem 1rem; border-radius: 12px; border: 1px solid #e5e7eb; outline: none; font-size: 0.95rem;">
                </div>
                <div>
                    <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #374151; margin-bottom: 0.4rem;">Confirm Password</label>
            ...
            <div style="margin-bottom: 1.25rem;">
                ...
                <select name="userLevel" required
                    ...
                    <option value="1" {{ old('userLevel') == 1 ? 'selected' : '' }}>Staff</option>
                    <option value="5" {{ old('userLevel') == 5 ? 'selected' : '' }}>Admin</option>
                </select>
            </div>

            <div style="margin-bottom: 2rem;">
                <label style="display: block; font-size: 0.85rem; font-weight: 700; color: #374151; margin-bottom: 0.4rem;">Branch (staff only)</label>
